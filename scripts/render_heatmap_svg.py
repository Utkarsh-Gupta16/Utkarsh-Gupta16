#!/usr/bin/env python3
"""
Render data/contributions.json as a proper GitHub-style contribution heatmap SVG.
Revealed once with a diagonal slide-down, then freezes.
"""
import datetime
import json
import os
...
# Load username for the titlebar
USERNAME = "user"
if os.path.exists(CONFIG_PATH):
    with open(CONFIG_PATH, "r") as f:
        USERNAME = json.load(f).get("username", "user")

# GitHub-ish green ramp
